@php
    $classForm =
        'py-3 px-4 block w-full border border-gray-200 text-sm focus:border-green-600 focus:ring-green-600 active:border-green-600 active:ring-green-600 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-green-600';
@endphp
<section class="flex justify-center items-center min-h-screen bg-gradient-to-tr from-green-50 to-green-100">
                    ...
                    <div class="p-4 sm:p-7">
                        ...
                        <form wire:submit="save">
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input wire:model="job" type="text" id="job" name="job"
                                            class="form" aria-describedby="job-error"
                                ...
                                <!-- Form Group -->
                                <div>
                                    <label for="room_id" class="block text-sm mb-2 dark:text-white">Nomor Ruangan<span
                                ...
                                <div>
                                    ...
                                    <div class="relative" id='statusMessage'>
                                        <input wire:model="image_ktp" class="form" type="file" accept="image/*" name="image_ktp" aria-describedby="image_ktp-error">
                                        @error('image_ktp')
                                            <div
                                                class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                                                <svg class="h-5 w-5 text-red-500" width="16" height="16"
                                ...
                                {{-- <div class="p-2 flex justify-start items-start gap-2 border">
                                    <input wire:model="agreement" type="checkbox" id="agreement" name="agreement"
                                        class="mt-1" aria-describedby="agreement-error">
                                ...
                                <button
                                    class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold border border-transparent bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Daftar</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
